...
-- loadstring(game:HttpGet('https://raw.githubusercontent.com/0Xd01x/automatic-barnacle/main/B2A.lua'))()
...
if teleport_execute then
    teleport_execute("loadstring(game:HttpGet('https://raw.githubusercontent.com/0Xd01x/automatic-barnacle/main/B2A.lua'))()")
end
