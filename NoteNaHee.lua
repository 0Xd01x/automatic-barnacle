        ...
        for Player, Handle in next, Players do
            if Player and LocalPlayer and Player ~= LocalPlayer and __UAnEv1__.PlayerEspObjects[Player] then
                task.spawn(function()
                    ...
                    local NameObject          =   EspObjects.Not
                    local Tracer              =   EspObjects.Not
                    local Box                 =   EspObjects.Box
                    local HealthLineRed       =   EspObjects.Not
                    local Healt hLineGreen     =  EspObjects.Not
                    local DistanceObject      =   EspObjects.Not
                    local Box3                =   EspObjects.Box3

                    local Skeleton    =   Iterables.Not
